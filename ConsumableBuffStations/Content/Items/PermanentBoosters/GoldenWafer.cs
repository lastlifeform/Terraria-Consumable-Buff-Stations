...
{
    public class GoldenWafer : ModItem
    {
        ...
        {
            return !player.GetModPlayer<PermanentBuffPlayer>().AltarUnlocked;
        }
        public override bool? UseItem(Player player)
        {
            player.GetModPlayer<PermanentBuffPlayer>().AltarUnlocked = true;
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            tooltips.Add(new TooltipLine(Mod,
                "PermanentUnlock",
                "Permanently grants the effects of an Altar"));
        }
    }
}
